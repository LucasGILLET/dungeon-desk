...
const buttonClasses = computed(() => {
  ...
  return 'fixed bottom-6 right-6 z-[90] inline-flex items-center gap-3 rounded-full border border-amber-500/30 bg-zinc-900/95 px-4 py-3 text-sm font-semibold text-amber-200 shadow-2xl shadow-black/40 backdrop-blur-md transition-all duration-200 hover:-translate-y-1 hover:border-amber-400/60 hover:bg-zinc-800 hover:text-amber-100'
})
